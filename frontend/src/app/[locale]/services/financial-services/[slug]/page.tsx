...
export default function ServicePage({params}: {params: {slug: string}}) {
    ...
    const {data:service, isLoading, isError} = useQuery({
        queryKey:['financial-service', slug],
    ...
    <>
        <NavigationWrapper />
        <HeaderSection pageTitle={{en:service.title_EN,ar:service.title_AR}} pageImage={HTFetched && headerImages.financialServices} breadCrumbArr={{en:['Services','Financial Services'],ar:['الخدمات','الخدمات المالية ']}} breadCrumbLinkArr={['/services','/services/financial-services']}/>
