...
export default function ServicePage({params}: {params: {slug: string}}) {
    ...
    const {data:service, isLoading, isError} = useQuery({
        queryKey:['auditing-service', slug],
    ...
    return (
        <>
            <NavigationWrapper />
            <HeaderSection pageTitle={{en:service.title_EN,ar:service.title_AR}} pageImage={HTFetched && headerImages.auditingServices} breadCrumbArr={{en:['Services','Auditing Services'],ar:['الخدمات','خدمات المراجعة']}} breadCrumbLinkArr={['/services','/services/auditing-services']}/>
