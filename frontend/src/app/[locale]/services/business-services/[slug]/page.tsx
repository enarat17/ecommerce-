...
export default function ServicePage({params}: {params: {slug: string}}) {
    ...
    return (
        <>
            <NavigationWrapper />
            <HeaderSection pageTitle={{en:service.title_EN,ar:service.title_AR}} pageImage={HTFetched && headerImages.businessServices} breadCrumbArr={{en:['Services','Business Services'],ar:['الخدمات','خدمات أعمالي']}} breadCrumbLinkArr={['/services','/services/business-services']}/>
