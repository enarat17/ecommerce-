...
export default function ServicePage({params}: {params: {slug: string}}) {
    ...
    return (
        <>
        <NavigationWrapper />
        <HeaderSection pageTitle={{en:service.title_EN,ar:service.title_AR}} pageImage={HTFetched && headerImages.HrServices} breadCrumbArr={{en:['Services','HR Services'],ar:['الخدمات','خدمات الموارد البشرية']}} breadCrumbLinkArr={['/services','/services/hr-services']}/>
