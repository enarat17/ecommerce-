...
export default function ContactUs() {
  ...
  return (
    <>
        <NavigationWrapper />
        <HeaderSection pageTitle={{en:'Quries and Questions', ar:'الأسئلة والإستفسارات'}} pageImage={isFetched && contactInfo.coverImage} breadCrumbArr={{en:['contact us'],ar:['تواصل معنا']}} breadCrumbLinkArr={['/contact-us']} />
