...
export default function ProductPage({params}: {params: {slug: string}}) {
    ...
    const {data:product, isLoading, isError} = useQuery({
        queryKey:['financial-product', slug],
    ...
    return (
        <body className='w-full' >
            ...
            <div className='flex flex-col items-center'>
                <HeaderSection pageTitle={{en:product.title_EN,ar:product.title_AR}} pageImage={HTFetched && headerImages.Financial_Store} breadCrumbArr={{en:['store','Financial-store'],ar:['المتجر','المتجر المالي']}} breadCrumbLinkArr={['/store','/store/financial-store']}/>
